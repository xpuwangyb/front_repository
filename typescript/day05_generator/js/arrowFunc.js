...
//case1: 无参数
var sysDate = function () { return new Date().toString(); };
console.log(">>>>arrow function---have no param>>>>sysDate:" + sysDate());
//case2: 只有一个参数
var totalNum = function (numVal) { return numVal; };
...
myFunction();
console.log("===========================");
var arrowFilterResult = ages.filter(function (age) { return age >= 18; });
console.log("****the arrow filter result ages bigger than 18 is:" + arrowFilterResult);
ages.forEach(function (age) { return console.log("******new age:" + (age + 1) + "****"); });
var arrowAddAgeResult = ages.map(function (age) { return age + 1; });
console.log("***********arrowAddAgeResult:" + arrowAddAgeResult);
var calTotalNumByReduce = ages.reduce(function (total, val) { return total + val; });
...
(function testThis() {
    ...
    this.myName = "WYB";
    setTimeout(function () {
        console.log("********this.name:" + _this.myName + "******");
    }, 5000);
})();
(function testThis() {
    this.myName = "WYB";
